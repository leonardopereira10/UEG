...
void ConsultaAluno::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConsultaAluno *_t = static_cast<ConsultaAluno *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ConsultaAluno::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConsultaAluno.data,
      qt_meta_data_ConsultaAluno,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConsultaAluno::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConsultaAluno.stringdata0))
        return static_cast<void*>(const_cast< ConsultaAluno*>(this));
