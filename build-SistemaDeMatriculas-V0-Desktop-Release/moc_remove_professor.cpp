...
QT_MOC_LITERAL(1, 17, 26), // "on_campo_cpf_returnPressed"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 21) // "on_pushButton_clicked"

    },
    "remove_professor\0on_campo_cpf_returnPressed\0"
...
void remove_professor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        remove_professor *_t = static_cast<remove_professor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject remove_professor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_remove_professor.data,
      qt_meta_data_remove_professor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *remove_professor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_remove_professor.stringdata0))
        return static_cast<void*>(const_cast< remove_professor*>(this));
