...
void ListaAlunos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ListaAlunos *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ListaAlunos::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ListaAlunos.data,
    qt_meta_data_ListaAlunos,
    qt_static_metacall,
    nullptr,
    nullptr
} };
