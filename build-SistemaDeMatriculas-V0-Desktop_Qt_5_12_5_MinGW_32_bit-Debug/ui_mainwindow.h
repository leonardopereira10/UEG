...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/recursos/Imagens/logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/recursos/Imagens/Exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSair->setIcon(icon1);
        actionManual = new QAction(MainWindow);
        actionManual->setObjectName(QString::fromUtf8("actionManual"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/recursos/Imagens/manual.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionManual->setIcon(icon2);
        actionSobre = new QAction(MainWindow);
        actionSobre->setObjectName(QString::fromUtf8("actionSobre"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/recursos/Imagens/sobre.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        actionOrganizar_janelas_lado_a_lado->setObjectName(QString::fromUtf8("actionOrganizar_janelas_lado_a_lado"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/recursos/Imagens/ladoLado.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionOrganizar_janelas_lado_a_lado->setIcon(icon4);
        actionOrganizar_janelas_em_cascata = new QAction(MainWindow);
        actionOrganizar_janelas_em_cascata->setObjectName(QString::fromUtf8("actionOrganizar_janelas_em_cascata"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/recursos/Imagens/cascata.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/recursos/Imagens/Aluno.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/recursos/Imagens/Professores.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuProfessores->setIcon(icon7);
        menuCursos = new QMenu(menuArquivo);
        menuCursos->setObjectName(QString::fromUtf8("menuCursos"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/recursos/Imagens/Curso.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/recursos/Imagens/Disciplinas.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/recursos/Imagens/Cadastrar.png"), QSize(), QIcon::Normal, QIcon::Off);
...
#endif // QT_NO_SHORTCUT
        actionOrganizar_janelas_lado_a_lado->setText(QApplication::translate("MainWindow", "Organizar janelas lado a lado", nullptr));
#ifndef QT_NO_SHORTCUT
        actionOrganizar_janelas_lado_a_lado->setShortcut(QApplication::translate("MainWindow", "Ctrl+E, L", nullptr));
#endif // QT_NO_SHORTCUT
        actionOrganizar_janelas_em_cascata->setText(QApplication::translate("MainWindow", "Organizar janelas em cascata", nullptr));
#ifndef QT_NO_SHORTCUT
        actionOrganizar_janelas_em_cascata->setShortcut(QApplication::translate("MainWindow", "Ctrl+E, C", nullptr));
#endif // QT_NO_SHORTCUT
