...
public:
    ...
    void setupUi(QWidget *ListarTodasMatriculas)
    {
        ...
        ListarTodasMatriculas->resize(866, 420);
        QIcon icon;
        ...
        tabWidget->setGeometry(QRect(10, 20, 841, 391));
        tab = new QWidget();
        tab->setObjectName(QStringLiteral("tab"));
        tableView = new QTableView(tab);
        tableView->setObjectName(QStringLiteral("tableView"));
        tableView->setGeometry(QRect(10, 5, 821, 331));
        tabWidget->addTab(tab, QString());
        pushButton = new QPushButton(ListarTodasMatriculas);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(765, 6, 80, 29));
